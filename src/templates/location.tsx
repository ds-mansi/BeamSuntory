...
export const getHeadConfig: GetHeadConfig<TemplateRenderProps> = ({
  ...
  return {
    title: document.c_meta_title
      ...
      : `${document.name} Store of Beam Suntory`,
    charset: "UTF-8",
        ...
        attributes: {
          ...
          content: `${
            document.c_meta_description
              ? document.c_meta_description
              : `Find the ${document.name} Beam Suntory Store in ${document.address.city}. We stock high-quality, robust products at competitive rates.`
          }`,
        },
      },
...
const Location: Template<ExternalApiRenderData> = ({
  ...
  // console.log(_site?.c_socialIcon,"site")
    ...
    <>
      ...
      >
        ...
        <AnalyticsScopeProvider name={""}>
          ...
          <Header head={_site?.c_header} navbar={_site?.c_header?.navbar} />
          ...
          {/* </PageLayout> */}
          <Footer
            flist={_site?.c_footerListing}
            site={_site}
            icon={_site?.c_socialIcon}
            copy={_site?.c_copyright}
          />
        </AnalyticsScopeProvider>
      </AnalyticsProvider>
    </>
